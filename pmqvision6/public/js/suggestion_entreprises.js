...
function lookup(inputString) {
	...
	if(inputString.length == 0) { // si le champs txte est vide
		...
		$.post(baseUrl+"/ajax/autocompletionentreprises", {queryString: ""+inputString+""}, function(data){ // on envoit la valeur du champ texte dans la variable post queryString au fichier ajax.php
			if(data.length >0) {
